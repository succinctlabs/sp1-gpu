...
extern "C" {
    ...
    pub(crate) fn cuda_malloc_host(ptr: *mut *mut c_void, size: usize) -> CudaRustError;
    pub(crate) fn cuda_host_register(ptr: *mut c_void, size: usize) -> CudaRustError;
    pub(crate) fn cuda_free_host(ptr: *mut c_void) -> CudaRustError;
    pub(crate) fn cuda_host_unregister(ptr: *mut c_void) -> CudaRustError;
