...
const LIB_NAME: &str = "moongate_cuda";
...
const SOURCE_DIRNAME: &str = "bindings";
...
fn main() {
    ...
    let cbindgen_hpp = &format!("{LIB_NAME}_cbindgen.hpp");
    ...
    let sp1tracegen_include_dir = env::var("DEP_SP1_CORE_MACHINE_SYS_INCLUDE").unwrap();
