...
// __global__ void compressAndInject(DeviceSlice<bb31_t[DIGEST_WIDTH]>
// prevLayer,
//                                   DeviceSlice<RowMajorMatrix>
//                                   matricesToInject,
//                                   DeviceSlice<bb31_t[DIGEST_WIDTH]>
//                                   nextDigests, poseidon2_bb31_16::Hasher
//                                   hasher) {
//     int rowIdx = (blockIdx.x * blockDim.x) + threadIdx.x;
...
//                 matricesToInject[i].width * rowIdx,
...
//         DeviceSlice<bb31_t[DIGEST_WIDTH]> digests,
//         DeviceSlice<bb31_t[WIDTH]> external_rc, DeviceSlice<bb31_t>
//         internal_rc, size_t nBlocks, size_t nThreadsPerBlock) { Hasher hasher
//         = Hasher(external_rc, internal_rc);
...
//         internal_rc, size_t nBlocks, size_t nThreadsPerBlock) { Hasher hasher
//         = Hasher(external_rc, internal_rc);
//         merkle_tree_kernels::compressAndInject<<<nBlocks,
//         nThreadsPerBlock>>>(
