...
template<typename T> __device__ __inline__ void Brent_Kung_scan(T *d_out, T * d_in, T* aux, 
...
template<typename T> __global__ void single_block_scan(T *d_out, T* d_in, size_t n) {
