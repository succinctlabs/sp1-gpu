...
pub fn write_measurements_to_csv(measurements: &[Measurement], filename: &str) -> Result<()> {
...
impl Measurement {
    ...
    fn to_csv_record(
        &self,
    ) -> (String, usize, usize, f64, f64, f64, f64, u128, f64, f64, f64, f64, f64, f64) {
        ...
        (
            ...
            self.core_proving_time.as_millis(),
